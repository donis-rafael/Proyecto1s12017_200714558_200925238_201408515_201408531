<%-- 
    ...
    Created on : 21/03/2017, 12:00:47 AM
    Author     : KMMG
--%>
...
<head>
	...
	<title>Eliminar Activo | Panel de Control - Proyecto 1 - EDD - 1S-2017</title>
			...
			<article class="login col-xs-10 col-sm-10  col-md-8">
				<center>
					<form method="POST" action="delete">
						...
						<br>
						<textarea id="desc" class="col-xs-12 col-sm-12  col-md-12" name="desc" rows="6" cols="60" placeholder="Descripción del prodcuto" disabled="disabled"></textarea>
						<br>
						<br>
						<br>
						<br>
						...
						<br>
						<br>
						<input type="submit" name="deleteProd" value="Eliminar Activo">
						<br>
						<br>
						<br>
						<br>
